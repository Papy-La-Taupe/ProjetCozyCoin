...
<%@include file="../jspFilesShared/B_header.jsp"%>
    ...
    <form action="profil" method="POST">
        ...
        <div>
            <a><img id="UpdatePrenom" src="${pageContext.request.contextPath}/medias/update_profile2.png" alt=""></a>
        ...
        <div>
            <a><img id="UpdateEmail" src="${pageContext.request.contextPath}/medias/update_profile2.png" alt=""></a>
        ...
        <div>
            <a><img id="UpdateTelephone" src="${pageContext.request.contextPath}/medias/update_profile2.png" alt=""></a>
        ...
        <div>
            <a><img id="UpdateRue" src="${pageContext.request.contextPath}/medias/update_profile2.png" alt=""></a>
        ...
        <div>
            <a><img id="UpdateCodePostal" src="${pageContext.request.contextPath}/medias/update_profile2.png" alt=""></a>
        ...
        <div>
            <a><img id="UpdateVille" src="${pageContext.request.contextPath}/medias/update_profile2.png" alt=""></a>
        ...
        <div>
            <a><img id="UpdateMotDePasse" src="${pageContext.request.contextPath}/medias/update_profile2.png" alt=""></a>
